    ...
    return (
        <>
            ...
            <div className="mainWrap min-h-screen max-h-[100vh] flex flex-col p-4 bg-[#f6f7fb]  text-[#1c292e] Pretendard-r">
                <header
                    className={`h-[70px]  bg-[#f4f8fb] shadow-md flex items-center justify-between rounded-lg mb-4 ${
                        isMobile ? 'p-1.5' : 'p-4'
                    }`}
                >
                    ...
                    <button
                        ...
                        className={
                            isSharing
                                ? 'px-3.5 py-2 bg-red-600 hover:bg-red-700 transition-colors text-white font-bold rounded-lg Pretendard-r'
                                : 'px-3.5 py-2 bg-[#004cfb] hover:bg-green-700 transition-colors text-white font-bold rounded-lg Pretendard-r '
                        }
                    >
